...
def mrr(similarity_matrix):
    ...
    :param similarity_matrix: torch.Tensor, square matrix, (i, j)th position of which represents (possibly not normalized)
        similarity of ith text sample and jth code sample
